...
mkdir -p ${BASE_DIR}/src/static/vendor
...
mkdir -p ${BASE_DIR}/src/static/vendor/bootstrap
cp -r ${BASE_DIR}/tmp/bootstrap-4.1.3/scss/* ${BASE_DIR}/src/static/vendor/bootstrap
...
mkdir -p ${BASE_DIR}/src/static/vendor/fontawesome
cp -r ${BASE_DIR}/tmp/font-awesome-4.7.0/scss/* ${BASE_DIR}/src/static/vendor/fontawesome


# Install Fonts
mkdir -p ${BASE_DIR}/src/static/vendor/fonts
wget https://www.1001fonts.com/download/open-sans.zip  -P ${BASE_DIR}/tmp
unzip -o -d ${BASE_DIR}/src/static/vendor/fonts ${BASE_DIR}/tmp/open-sans.zip
wget https://www.1001fonts.com/download/roboto-slab.zip  -P ${BASE_DIR}/tmp
unzip -o -d ${BASE_DIR}/src/static/vendor/fonts ${BASE_DIR}/tmp/roboto-slab.zip
